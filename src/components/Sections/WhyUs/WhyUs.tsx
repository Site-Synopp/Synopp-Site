  ...
  return (
    <section className="bg-[#0a0a16] text-white py-16 relative overflow-hidden z-10 w-full">
      <div className="container mx-auto px-4">
        ...
        <h1 className="text-4xl md:text-6xl font-bold mb-6 pb-1 leading-tight bg-gradient-to-t from-[#BFBEC3] via-[#E2E1E4] to-[#F2F2F3] text-transparent bg-clip-text">{t("TITLE")}</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {advantages.map((advantage) => (
            <div key={advantage.id} className="flex justify-center">
              <ResponsiveCard
                icon={<div className={`p-3 rounded-lg ${advantage.iconBgColor}`}> <Image src={advantage.icon} alt={advantage.id} width={24} height={24} /> </div>}

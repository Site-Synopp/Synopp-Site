    ...
    <AnimatePresence>
      {isOpenDialog && (
        <motion.div
          ...
          className="absolute top-12 right-[calc(50%-155px)] flex flex-col w-[280px] md:w-[330px] bottom-[calc(33%-65px)] h-[130px] bg-[#16112A] justify-center text-lg z-10 rounded-lg backdrop-blur-[100px] md:right-[0px] md:top-[9vh] md:bottom-0 border-[1px] border-[#EFEDFD66]"
        >
